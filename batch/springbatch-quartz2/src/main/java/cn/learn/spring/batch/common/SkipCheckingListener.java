...
public class SkipCheckingListener {
	...
	@OnSkipInWrite
	public void skipWrite(Player player, Throwable t) {
		logger.debug("Skipped writing " + player);
	}

	@OnSkipInProcess
	public void skipProcess(Player player, Throwable t) {
		logger.debug("Skipped processing " + player);
		processSkips++;
	}
